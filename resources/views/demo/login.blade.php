        ...
        <div class="columns is-flex is-justify-content-center">
          <div class="column is-10-mobile is-6-tablet is-5-desktop is-4-widescreen">
            <form action="" class="box">
              ...
              <div class="end has-text-centered mt-5">
                <p class="is-size-7 pb-2 has-text-grey-light">Don't have an account?</p>
                <a href="{{ url('demo/sign-up') }}" class="has-text-primary">SIGN UP</a>
              </div>
            </form>
          </div>
        </div>
